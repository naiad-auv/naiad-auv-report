...
\title{Naiad AUV motion control system}
...
\alignauthor
Emil Bergstr\"om\\
       \email{ebm09003@student.mdh.se}
% 2nd. author
%\alignauthor
%Per-Erik M\aa hl\\
    %   \email{pml09001@student.mdh.se}
}
...
\keywords{ PID control, motion control, autonomous underwater vehicle, Naiad AUV, component based software engineering} % NOT required for Proceedings
