...
\title{Underwater Visual Perception System}
...
% Add names, affiliations, addrZhesses for
...
M\"{a}lardalen University\\
       \email{GerardDuff@Gmail.com}
% 2nd. author
\alignauthor
Debajyoti Nag\\
Intelligent Embedded Systems\\
M\"{a}lardalen University\\
       \email{dave0908@gmail.com}
}
...
\keywords{OpenCV, Point Cloud Library, Ada, Computer Vision} % NOT required for Proceedings
