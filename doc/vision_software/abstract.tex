...
Additionally, it has a module that allows to estimate the velocity of the AUV using stereo images. The system was primarily developed using Ada programing language, to introduce safety critical features to the system. 
