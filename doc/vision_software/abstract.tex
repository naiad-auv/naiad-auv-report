...
Additionally, it has a module that estimates the velocity of the AUV using stereo images. The system was primarily developed using the Ada programing language, to introduce safety critical features to the system. 
