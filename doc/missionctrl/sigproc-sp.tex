...
\lstset{
  ...
  emph={regexp,ε},
  emphstyle=\textbf,
  %morecomment=[n][\textbf]{regexp},
  morecomment=[n][\textbf]{\'}{\'{}},
  %morecomment=[n][\textbf]{ε},
...
\title{Mission Control System for Project Naiad
\titlenote{This report was
...
Mikael Ekstr\"{o}m, Evaluator\newline
\textit{mikael.ekstrom@mdh.se}\newline\newline
Lars Asplund, Customer\newline
\textit{lars.asplund@mdh.se}
}}
