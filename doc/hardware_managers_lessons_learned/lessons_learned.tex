...
\subsection{Acquire test equipment}\label{sec:test}
...
When a student project begins, make sure that you get access to the equipment that you will need as soon as possible. Keep in mind that there will often be a delay from that you request to get something till you actually get it. This delay is likely to be longer than you expect.
