...
The ADS1255 analog-to-digital converter runs at 100 samples per second and has a resolution of 24 bits, however only about <INSERT EFFECTIVE RESOLUTION> are accurate at this sample rate. \newline
