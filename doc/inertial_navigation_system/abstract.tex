...
The IMU and FOG are connected to a circuit board known as the \emph{INS board}. This circuit serves as an electrical interface to a Generic CAN controller that reads the sensors and outputs the their readings on the CAN bus. \newline
